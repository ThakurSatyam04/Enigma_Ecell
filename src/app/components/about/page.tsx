...
import img1 from '@/app/Assests/about_img1.png'
import img2 from '@/app/Assests/about_image2.png'
...
const AboutPage = () => {
  return (
    <div className='min-h-screen'>
        ...
        <div className='w-full flex items-center justify-center'>
            <div className='w-9/12 flex gap-20 sm:mt-20 mt-10 justify-center'>
